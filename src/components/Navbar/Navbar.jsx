    ...
    return (
        <nav className={classes.nav}>
            <ul className={classes.nav__ul}>
                <li><i className="far fa-user-circle" activeClassName={classes.nav__active}></i><NavLink className={classes.nav__item} activeClassName={classes.nav__active} to="/profile">Profile</NavLink></li>
